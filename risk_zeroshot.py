...
Runs facebook/bart-large-mnli model on all emails with hits_total > 0
(OneDrive version – paths point to your local maildir)
"""
...
HYBRID_PATH = BASE_DIR / "RiskScores.parquet"     # hybrid keyword file with hits_total
...
classifier = pipeline("zero-shot-classification", model="facebook/bart-large-mnli", device=-1)  # CPU on local machine
